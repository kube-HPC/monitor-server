...
class ResultGather extends Events {
    ...
    async _resultsGatherInterval() {
        ...
        try {
            ...
            this.emit('result', { nodeStatistics, diskSpace, pipelinesStats, jobs, logs: redisLogs, discovery, algorithms, pipelines, experiments, dataSources, algorithmBuilds, boards: { batchMap, taskMap, nodeMap } });
        }
        catch (error) {
