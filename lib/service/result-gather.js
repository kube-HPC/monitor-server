...
class ResultGather extends Events {
    ...
    async _resultsGatherInterval() {
        ...
        try {
            ...
            const { jobs, discovery, algorithms, pipelines, algorithmBuilds } = etcdApi.getLastResults();
            ...
            this.emit('result', { nodeStatistics, pipelinesStats, jobs, logs: redisLogs, discovery, algorithms, pipelines, algorithmBuilds });
        }
        catch (error) {
