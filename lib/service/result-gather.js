...
class ResultGather extends Events {
    ...
    async _resultsGatherInterval() {
        ...
        try {
            ...
            this.emit('result', { nodeStatistics, pipelinesStats, jobs, logs: redisLogs, discovery, algorithms, pipelines, experiments, algorithmBuilds, boards: { batchMap, taskMap, nodeMap } });
        }
        catch (error) {
